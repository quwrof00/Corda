...
export function InviteModal({
    ...
    return (
        ...
        >
            <div
                className="w-full h-full sm:h-auto max-w-md bg-white dark:bg-zinc-950 sm:border border-zinc-200 dark:border-zinc-800 p-6 shadow-2xl sm:rounded-2xl"
...
export function EditTeamModal({
    ...
    return (
        ...
        >
            <div
                className="bg-white dark:bg-zinc-950 p-6 sm:border border-zinc-200 dark:border-zinc-800 w-full h-full sm:h-auto max-w-lg shadow-2xl sm:rounded-2xl flex flex-col"
                onClick={(e) => e.stopPropagation()}
            >
